...
The similarities to OCaml are important since it means programmers who are comfortable with that language will have an easier adaptation period when writing code in BipLang.
...
Therefore, we were able to reduce relational verification to standard verification, which is currently a much easier path to prove program equivalence.
...
It would be only a matter of providing a strong enough specification.
...
We wonder if we could infer trivial variants and some other invariants, adding then those to the specification attached to the final generated code.
That would be a promising way of reducing the weight off the shoulders of the users of bip2ml.
