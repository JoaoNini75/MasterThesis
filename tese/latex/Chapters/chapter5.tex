...
\begin{minipage}{\linewidth}
\begin{biplangenv}
  TODO: change to give desired output, need type implemented to do it
...
\end{biplangenv}
\end{minipage}
\caption{The match and assert constructions (BipLang)}
\end{figure}
% TODO: put more space
...
\end{gospel}
\end{minipage}
\caption{The match and assert constructions (OCaml)}
\end{figure}
% TODO: put more space
