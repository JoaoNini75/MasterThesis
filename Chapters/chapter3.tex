...
Cross-products~\cite{DBLP:conf/fm/ZaksP08}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \begin{minipage}[t]{\linewidth}
      ...
      \begin{lstlisting}[escapeinside={(*}{*)}, style=while_lang]
        .i(*\textasciiacute*) := 0.;
        .j(*\textasciiacute*) := C.;
        while (.i(*\textasciiacute*) < N.) do
          .x(*\textasciiacute*) += j(*\textasciiacute*).;
          .j(*\textasciiacute*) += B.;
          .i(*\textasciiacute*)++.
      \end{lstlisting}
    \end{minipage}
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{minipage}[t]{\linewidth}
      \textbf{Product program}
      \begin{lstlisting}[escapeinside={(*}{*)}, style=while_lang]
        @i := 0@; .i(*\textasciiacute*) := 0.; .j(*\textasciiacute*) := C.;
        while (@i < N@ (*$\land$*) .i(*\textasciiacute*) < N.) do
          @j := i * B + C@; @x += j@; @i++@
          .x(*\textasciiacute*) += j(*\textasciiacute*).; .j(*\textasciiacute*) += B.; .i(*\textasciiacute*)++.
      \end{lstlisting}
    \end{minipage}
  \end{subfigure}
