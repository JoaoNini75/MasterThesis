...
Although the imperative paradigm is still more popular than the functional paradigm, the latter has been conquering space in the universe of programming languages whose focus is on the imperative approach: Java, Kotlin,

\subsection{Relevance} 
\label{sub:relevance}

software written + companies that use
